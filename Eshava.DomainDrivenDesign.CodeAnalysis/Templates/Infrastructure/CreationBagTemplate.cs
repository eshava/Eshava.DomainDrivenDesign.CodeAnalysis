...
namespace Eshava.DomainDrivenDesign.CodeAnalysis.Templates.Infrastructure
{
	...
	{
		public static string GetCreationBag(
		...
		)
		{
			...
			var unitInformation = new UnitInformation(modelName, @namespace, addAssemblyComment: environment.Project.AddAssemblyCommentToFiles);
